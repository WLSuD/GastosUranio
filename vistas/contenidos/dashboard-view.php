          ...
          <!-- Sales Card -->
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pagados <span>| Total</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pendientes <span>| Total</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php 
                        ...
                        $gastos_pendientes   =   $lc->ejecutar_consulta_simple_publica("SELECT * FROM gastos WHERE programaId = $programaId AND estadoGasto IS NULL");
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Programados <span>| Total</span></h5>
