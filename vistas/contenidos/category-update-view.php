...
<div class="container-fluid">
    <?php
        ...
        $datos_categoria=$lc->datos_tabla("Unico","categorias","categoriaId",$pagina[1]);
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-99áéíóúÁÉÍÓÚñÑ ]{10,100}" class="form-control" name="categoria_up" value="<?php echo $campos['categoria']; ?>" id="categoria" maxlength="40">
                        </div>
                    </div>
                    <!--
                    <div class="col-12 col-md-6">
