<?php
	...
	class usuarioControlador extends mainModel{
        ...
        public function agregar_usuario_controlador(){
            ...
            $nombre=mainModel::limpiar_cadena(strtoupper($_POST['usuario_nombre_reg']));
            $apellido=mainModel::limpiar_cadena(strtoupper($_POST['usuario_apellido_reg']));
        ...
        public function actualizar_usuario_controlador(){
            ...
            $nombre=mainModel::limpiar_cadena(strtoupper($_POST['usuario_nombre_up']));
            $apellido=mainModel::limpiar_cadena(strtoupper($_POST['usuario_apellido_up']));
